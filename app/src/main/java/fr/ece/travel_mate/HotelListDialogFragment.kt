...
class HotelListDialogFragment(private val value: DocumentSnapshot?) : BottomSheetDialogFragment() {
    ...
    override fun onCreateView(
        ...
        _binding = FragmentHotelListDialogListDialogBinding.inflate(inflater, container, false)
        return binding.root
...
//            arguments?.getInt(ARG_ITEM_COUNT)?.let { ItemAdapter(it) }
    ...
    private inner class ViewHolder internal constructor(binding: FragmentHotelListDialogListDialogItemBinding) :
        RecyclerView.ViewHolder(binding.root) {

        internal val text: TextView = binding.text
    }

    private inner class HotelAdapter internal constructor(private val mItemCount: Int) :
        RecyclerView.Adapter<ViewHolder>() {

        override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {

            return ViewHolder(
                FragmentHotelListDialogListDialogItemBinding.inflate(
                    LayoutInflater.from(
                        parent.context
                    ), parent, false
                )
